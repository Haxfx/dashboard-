...
export const Menu = () => {
  ...
  return (
    <>
      <div className="flex flex-row justify-between px-2 items-center h-20 w-full bg-purple-dark lg:hidden bottom-0 z-10 fixed">
        <div className="group w-auto h-full flex flex-row items-center p-3 border-b-4 border-purple-primary">
          <HomeIcon className="h-7 w-7 text-purple-primary" />
        </div>
        <div className="group w-auto h-full flex flex-row items-center p-3 cursor-pointer border-b-4 border-transparent hover:border-b-4 hover:border-purple-primary">
          <LibraryIcon className="h-7 w-7 group-hover:text-purple-primary" />
        </div>
        <div className="group w-auto h-full flex flex-row items-center p-3 cursor-pointer border-b-4 border-transparent hover:border-b-4 hover:border-purple-primary">
          <PlayIcon className="h-7 w-7 group-hover:text-purple-primary" />
        </div>
        <div className="group w-auto h-full flex flex-row items-center p-3 cursor-pointer border-b-4 border-transparent hover:border-b-4 hover:border-purple-primary">
          <FireIcon className="h-7 w-7 group-hover:text-purple-primary" />
        </div>
        <div className="group w-auto h-full flex flex-row items-center p-3 cursor-pointer border-b-4 border-transparent hover:border-b-4 hover:border-purple-primary">
          <CogIcon className="h-7 w-7 group-hover:text-purple-primary" />
        </div>
      </div>
