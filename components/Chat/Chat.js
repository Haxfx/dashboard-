  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex relative bg-purple-backgroundLight justify-start p-2 rounded-2xl mt-2">
        ...
        />
        <PaperAirplaneIcon className="w-7 h-7 p-1 rounded-full text-purple-white bg-purple-primary cursor-pointer hover:bg-white transform rotate-45 absolute right-2" />
      </div>
    </div>
  );
};
